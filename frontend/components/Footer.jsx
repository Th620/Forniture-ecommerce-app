...
const Footer = () => {
  return (
    <footer className="grid grid-cols-12 w-full py-10 px-150 bg-blueBg text-black font-montserrat">
      <Link href={"/"} className="col-span-2">
        <Image src={Logo} width={65} height={39} alt="logo" />
      </Link>
      {footerSections.map((item) => (
        <ul key={item.id} className="col-span-2">
      ...
      <div className="col-span-4">
        ...
        <Link href="/" className="text-gray text-[12px] underline">Terms & Privacy Policy</Link>
      </div>
