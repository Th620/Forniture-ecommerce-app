          ...
          {error && !error?.addToCart ? (
            ...
            <>
                        ...
                        >
                          {done && !reviewForm && (
                            <p className="text-sm text-justify px-3 py-2">
                              Your review will be visible after it has been
                              chacked and approved by our admin team.
                            </p>
                          )}
                          {reviewForm && (
                            <form
              ...
              <div className="md:mt-14 md:mb-14">
                <h3 className="font-semibold pb-2 text-lg">
                  You may also like
                </h3>
