...
const Banner = () => {
  return (
    <section className="flex flex-col justify-start gap-y-3 md:justify-center items-center md:items-start bg-beige bg-banner bg-contain md:bg-right-top bg-bottom bg-no-repeat h-[400px] sm:h-[500px] md:h-fit py-14 px-10 md:px-75 lg:px-150 text-black max-md:pb-28">
